...
const en: Dict = {
  ...
  lang_auto: "🌐 Auto",
  review_title: "Enjoying Yolo Chrome MCP?",
  review_body:
    "It helps a lot! A quick review on the Chrome Web Store really supports the project.",
...
const ja: Dict = {
  ...
  label_language: "言語",
  lang_auto: "🌐 自動",
  review_title: "Yolo Chrome MCP は役立っていますか？",
  review_body:
    "とても助かります！ Chrome ウェブストアに一言レビューをいただけると、開発の大きな励みになります。",
  review_cta: "★ レビューを書く",
  review_later: "後で",
...
const zh: Dict = {
  ...
  label_language: "语言",
  lang_auto: "🌐 自动",
  review_title: "Yolo Chrome MCP 用得还顺手吗？",
  review_body:
    "这对我们帮助很大！在 Chrome 应用商店留下简短评价，能大力支持这个项目。",
  review_cta: "★ 写评价",
  review_later: "以后再说",
